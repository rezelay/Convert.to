...
test.describe('Length units', () => {
  ...
  const expectations: Partial<TestScenario>[] = [
    ...
    { inputValue: 1, currentUnit: "meter", targetUnit: "mile", expected: 0.000621 },
    { inputValue: 1, currentUnit: "meter", targetUnit: "yard", expected: 1.0936 },
    { inputValue: 1, currentUnit: "meter", targetUnit: "foot", expected: 3.2808 },
    { inputValue: 1, currentUnit: "meter", targetUnit: "inch", expected: 39.3701 },
  ];
