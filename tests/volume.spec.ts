...
test.describe('Volume units', () => {
  ...
  const expectations: Partial<TestScenario>[] = [
    ...
    { inputValue: 1, currentUnit: "liter", targetUnit: "gallon_us", expected: 0.264 },
    { inputValue: 1, currentUnit: "liter", targetUnit: "gallon_uk", expected: 0.22 },
    { inputValue: 1, currentUnit: "liter", targetUnit: "cup", expected: 4.1667 }
  ];
